...
TECHNO_IMG = "https://te.legra.ph/file/676e3d44467e53a0bcfee.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="❤️HELP❤️",
                                                                       callback_data="help_back".format(bot.username)),
                                                                                   InlineKeyboardButton(text="❤️MY CREATER❤️",
                                                                       url="t.me/Om_varade")],
                                                                                   [InlineKeyboardButton(text="❤️ADD TO YOUR GROUP❤️",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="💙NEWS CHANNEL 💙",
                                                                       url="https://t.me/MissYouNews")
                                                                                 ]]))
